...
@section('title', 'إضافة قالب إشعارات جديد')
        ...
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">إضافة قالب إشعارات جديد</h3>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="notification_channel_id" name="notification_channel_id" required>
                                ...
                                @foreach($channels as $channel)
                                    <option value="{{ $channel->id }}" {{ old('notification_channel_id') == $channel->id ? 'selected' : '' }}>
