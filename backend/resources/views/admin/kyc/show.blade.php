                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <a href="{{ route('admin.kyc.batch-process') }}" class="btn btn-sm btn-info mx-2">
                                <i class="fas fa-robot"></i> معالجة متعددة بالذكاء الاصطناعي
                            </a>
                            @if($verification->status === 'pending')
                                <a href="{{ route('admin.kyc.process-with-ai', $verification->id) }}" class="btn btn-sm btn-primary">
                                    <i class="fas fa-robot"></i> معالجة بالذكاء الاصطناعي
                                </a>
                            @endif
                            @if($verification->ai_processed_at)
                                <a href="{{ route('admin.kyc.ai-analysis', $verification->id) }}" class="btn btn-sm btn-success">
                                    <i class="fas fa-chart-bar"></i> عرض تحليل الذكاء الاصطناعي
                                </a>
                            @endif
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm">
                                    ...
                                    @endif
                                    @if(isset($aiResults) && !empty($aiResults))
                                    <tr>
                                        <th class="text-xs">تقييم الذكاء الاصطناعي</th>
                                        <td class="text-xs">
                                            @if(isset($aiResults['overall_score']))
                                                <div class="d-flex align-items-center">
                                                    <div class="me-2">{{ $aiResults['overall_score'] }}</div>
                                                    <div class="progress" style="height: 6px; width: 100px;">
                                                        <div class="progress-bar 
                                                            @if($aiResults['overall_score'] >= 80)
                                                                bg-success
                                                            @elseif($aiResults['overall_score'] >= 60)
                                                                bg-warning
                                                            @else
                                                                bg-danger
                                                            @endif" 
                                                            role="progressbar" 
                                                            style="width: {{ $aiResults['overall_score'] }}%">
                                                        </div>
                                                    </div>
                                                </div>
                                            @else
                                    ...
                                    <tr>
                                        <th class="text-xs">توصية النظام</th>
                                        <td class="text-xs">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-xs">{{ $verification->admin_notes ?? 'لا توجد ملاحظات' }}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
