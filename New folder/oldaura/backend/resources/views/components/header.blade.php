            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-center justify-content-md-end small">
                        <div class="me-3">
                            <a href="{{ route('about') }}" class="text-muted">عن AURA</a>
                        </div>
                        <div class="me-3">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('features') ? 'active' : '' }}" href="{{ route('features') }}">المميزات</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('app') ? 'active' : '' }}" href="{{ route('app') }}">التطبيق</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('testimonials') ? 'active' : '' }}" href="{{ route('testimonials') }}">آراء العملاء</a>
                    </li>
                </ul>
                <div class="d-flex">
                    @auth
