<!DOCTYPE html>
<html lang="ar" dir="rtl" data-theme="{{ $userUiSettings->theme ?? 'light' }}">
<head>
    <meta charset="UTF-8">
    ...
    @auth
    <meta name="theme-update-url" content="{{ route('profile.ui-settings.update-theme') }}">
    @endauth
...
<body>
    ...
    <!-- زر تبديل المظهر (الوضع الداكن/الفاتح) -->
